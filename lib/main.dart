    ...
    return Scaffold(
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            children: [
              TextField(controller: eid,),
              TextField(controller: ename,),
              TextField(controller: ecity,),
              TextField(controller: esalary,),
              OutlinedButton(
                onPressed: (){
                  insert(int.parse(eid.text), ename.text, ecity.text, int.parse(esalary.text));
                },
